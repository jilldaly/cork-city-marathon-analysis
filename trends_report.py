...
Usage
-----
  python trends_report.py [--data cork_data] [--out cork_marathon_analysis.pdf]
...
from single_year_report import load_year, PDF_FILES
...
def load_data(data_dir: str, tmp_dir: str) -> pd.DataFrame:
    """Load and combine results for all supported years."""
    frames = []
    for year in YEARS:
