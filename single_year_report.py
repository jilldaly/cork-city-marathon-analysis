...
------------------------------------------------------
  2024/  results_full.pdf
         results_half.pdf
         results_10k.pdf

  2025/  results_full.pdf
         results_half.pdf
         results_10k.pdf

  2026/  results_full.pdf
         results_half.pdf
         results_10k.pdf
...
-----
  ...
  python single_year_report.py --year 2025 --data data/cork --out report_charts/
...
PDF_FILES = {
    2026: {'Full': 'results_full.pdf', 'Half': 'results_half.pdf', '10K': 'results_10k.pdf'},
    2025: {'Full': 'results_full.pdf', 'Half': 'results_half.pdf', '10K': 'results_10k.pdf'},
    2024: {'Full': 'results_full.pdf', 'Half': 'results_half.pdf', '10K': 'results_10k.pdf'},
}
...
def build_pdf(df, year, out_path, club_name=None):
    ...
    story.append(Paragraph('Report design using Claude Cowork · Code generated using Claude Code · Crafted by Humans', FOOT))
...
def build_club_section(df, club_name, year, story, styles, section_label=None):
    ...
    story.append(PageBreak())
    story.append(HR())
    heading = f'{section_label} Club Deep Dive: {club_name}' if section_label else f'Club Deep Dive: {club_name}'
...
def build_club_finish_time_page(df, club_name, story, styles, section_label=None):
    ...
    story.append(PageBreak())
    story.append(hr())
    heading = f'{section_label} {club_name} — Finish Time Analysis' if section_label else f'{club_name} — Finish Time Analysis'
    story.append(Paragraph(heading, SEC))
    story.append(Paragraph(
